                                    ...
                                    Forms\Components\Fieldset::make('clasificacion')->schema([
                                        ...
                                        Forms\Components\Select::make('infraregions_id')
                                            ...
                                            ->options(function (callable $get) {
                                                ...
                                                if (!$isystem) {
                                                    return [];
                                                    //return InfraRegion::all()->pluck('region_name', 'id');
                                                }
                                        ...
                                        Forms\Components\Select::make('infrafacilities_id')
                                            ->label('Instalación')
                                            ->options(function (callable $get) {
                                                $iregion = InfraRegion::find($get('infraregions_id'));
                                                if (!$iregion) {
                                                    return [];
                                                    //return InfraFacility::all()->pluck('facility_name', 'id');
                                                }
                                                return $iregion->infrafacilities->pluck('facility_name', 'id');
                                            }),
                                ...
                                Forms\Components\Group::make([
                                    ...
                                    Forms\Components\Fieldset::make('clasificacion')->schema([
                                        Forms\Components\TextInput::make('prof_tech')
                                            ->label('Prof. y Técnicos')->integer(),
                                        Forms\Components\TextInput::make('manpower')
                                            ->label('Mano de Obra Directa')->integer(),
