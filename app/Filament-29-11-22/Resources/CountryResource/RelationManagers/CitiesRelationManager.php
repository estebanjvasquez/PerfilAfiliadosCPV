        ...
        return $form
            ->schema([
                ...
                Forms\Components\BelongsToSelect::make('states_id')
                    ...
                    //->options(State::where('country_id', '=', Country::query('select id from country where id = 2')->pluck('id', 'country_name'))->pluck('state_name', 'id'))
                    ->label('Estado'),
                //    ->options(State::all()->pluck('state_name', 'id')->toArray()),
                //->options(State::where('country_id', '=',)->pluck('state_name', 'id')->toArray()),
