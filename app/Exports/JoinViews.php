...
class JoinViews extends Page
{
    ...
    public static function index_pres($a)
    {
        $data_pres = PresenceViewModel::where('PresenceView.id', '=', $a)->where('PresenceView.hasOfficesYes', '=', 'X')
            ->get([
                'PresenceView.hasOfficesYes', 'PresenceView.hasExperienceYes', 'PresenceView.pais as pais', 'PresenceView.mts', 'PresenceView.emp_q', 'PresenceView.activa'
    ...
    public static function index_recursos($a)
    {
        ...
        return view('filament.pages.join-views', compact('value_emp', 'value_maq', 'value_fac', 'data_rec', 'data_maq', 'data_ins'));
    }
}
