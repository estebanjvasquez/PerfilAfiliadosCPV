...
class EmpresaResource extends Resource
{
    ...
    {
        //$city = countries_cities::all()->pluck('country_name', 'city_name');
        return $form
            ->schema([
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('country.country_name')->label('País'),
                //Tables\Columns\TextColumn::make('street'),
                //Tables\Columns\TextColumn::make('website'),
                //Tables\Columns\TextColumn::make('users.name'),
                //Tables\Columns\TextColumn::make('sectors.name'),
                //Tables\Columns\TextColumn::make('services.name')->label('Servicios que presta la Empresa'),
                //Tables\Columns\TextColumn::make('services.sectors_id->sectors.name')->label('Sectors'),
