...
class InfraSystemResource extends Resource
{
    ...
    {
        return [
            RelationManagers\InfraregionsRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => Pages\ListInfraSystems::route('/'),
            'create' => Pages\CreateInfraSystem::route('/create'),
            'edit' => Pages\EditInfraSystem::route('/{record}/edit'),
        ];
    }
}
