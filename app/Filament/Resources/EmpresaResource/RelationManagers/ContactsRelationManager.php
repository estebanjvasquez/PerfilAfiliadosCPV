...
class ContactsRelationManager extends BelongsToManyRelationManager
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                // "Crear Contacto" (headerAction por defecto de BelongsToManyRelationManager,
                // no declarado explicitamente aca) tambien cambia el % de "Contactos" pero NO
                // se le agrega ->after() aca: reimplementar ese CreateAction a mano se arriesga
                // a romper su wiring interno (form, creacion+attach en un solo paso). Ese caso
                // (y cualquier otro que se escape) queda cubierto por el refresco periodico
                // programado en app/Console/Kernel.php (empresas:refresh-completion --only-stale).
