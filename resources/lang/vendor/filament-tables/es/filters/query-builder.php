...
return [
    ...
    'form' => [
        ...
        // Override del texto original de Filament ("Disyunción (O)") - encontrado ilegible para
        // un administrador no técnico (pedido del 7 sep: "no es posible seleccionar si la otra
        // condición es AND o un OR"). El bloque "O" SIEMPRE estuvo disponible en el selector de
        // "+ Agregar regla" (es un Builder\Block más, agregado por Filament\Tables\Filters\
        // QueryBuilder\Forms\Components\RuleBuilder junto a cada columna filtrable) - el problema
        // era el rótulo, no la funcionalidad. Ver docs/taxonomia para el resto del contexto de
        // este filtro. Este archivo es TODO el idioma es/ de este componente (Laravel reemplaza el
        // archivo entero al encontrar uno en resources/lang/vendor/, no hace merge clave por
        // clave), así que se copia completo desde vendor/filament/tables/.../es/filters/
        // query-builder.php y se toca solo esta etiqueta.
        'or_groups' => [

            'label' => 'Grupos "O"',

            'block' => [
                'label' => 'Agregar grupo "O" (que cumpla alguna de estas condiciones)',
                'or' => 'O',
            ],
