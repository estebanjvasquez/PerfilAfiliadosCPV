{{--
    Override de vendor/filament/forms/resources/views/components/wizard.blade.php.

    Unico cambio respecto al original: la barra de navegacion (Anterior/Siguiente/
    Guardar) pasa de flujo normal a "sticky bottom-0". El wizard de Editar/Crear
    Empresa tiene un paso final ("Clientes") con un Repeater sin limite de filas;
    cuando una empresa carga muchos clientes, el boton Guardar quedaba despues de
    todo ese listado, obligando a bajar hasta el final de la pagina para guardar.
    Con la barra fija, el usuario siempre puede guardar/avanzar sin buscarlo.
--}}
@php
...
>
    ...
    <div
        @class([
            'sticky bottom-0 z-10 flex items-center justify-between px-4 py-3 -mx-4 border-t bg-white/95 backdrop-blur',
            'dark:bg-gray-800/95 dark:border-gray-700' => config('forms.dark_mode'),
            'border-gray-300' => ! config('forms.dark_mode'),
        ])
    >
        <div>
            <x-forms::button
